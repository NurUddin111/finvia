...
const generateInvPdf = async (invoice) => {
        ...
        try {
            ...
            if (logoBuffer) {
                ...
                doc
                    .font("Helvetica")
                    .fontSize(10)
                    .text(`Issue Date: ${(0, formatDT_1.formatDateTime)(invoice.issueDate)}`, 405, 70);
                doc.text(`Due Date: ${(0, formatDT_1.formatDateTime)(invoice.dueDate)}`, 405, 85);
            }
            else {
                ...
                doc
                    .font("Helvetica")
                    .fontSize(10)
                    .text(`Issue Date: ${new Date(invoice.issueDate).toLocaleDateString("en-GB")}`, 456, 70);
                doc.text(`Due Date: ${new Date(invoice.dueDate).toLocaleDateString("en-GB")}`, 456, 85);
            }
...
exports.generateInvPdf = generateInvPdf;
